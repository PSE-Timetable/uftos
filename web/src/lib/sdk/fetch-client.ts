...
export function getConstraintSignatures(
  pageable: Pageable,
  {
    name,
  }: {
...
export function getConstraintInstances(
  signatureId: string,
  pageable: Pageable,
  {
    argument,
  ...
  return oazapfts.ok(
    oazapfts.fetchJson<{
      ...
      `/constraints/${encodeURIComponent(signatureId)}/instances${QS.query(
        QS.explode({
          pageable,
          argument,
        }),
...
export function createConstraintInstance(
  signatureId: string,
  request: ConstraintInstanceRequestDto,
  opts?: Oazapfts.RequestOpts,
) {
  return oazapfts.ok(
    oazapfts.fetchJson<{
...
export function deleteConstraintInstance(signatureId: string, id: string, opts?: Oazapfts.RequestOpts) {
  return oazapfts.ok(
    oazapfts.fetchText(`/constraints/${encodeURIComponent(signatureId)}/instances/${encodeURIComponent(id)}`, {
      ...opts,
      method: 'DELETE',
    }),
  );
...
export function updateConstraintInstanceById(
  signatureId: string,
  id: string,
  request: ConstraintInstanceRequestDto,
  opts?: Oazapfts.RequestOpts,
  ...
  return oazapfts.ok(
    oazapfts.fetchJson<{
      ...
      `/constraints/${encodeURIComponent(signatureId)}/instances/${encodeURIComponent(id)}${QS.query(
        QS.explode({
          request,
        }),
      )}`,
...
export function deleteCurriculum(id: string, opts?: Oazapfts.RequestOpts) {
  return oazapfts.ok(
    oazapfts.fetchText(`/curriculum/${encodeURIComponent(id)}`, {
      ...opts,
      method: 'DELETE',
    }),
  );
...
export function deleteGrade(id: string, opts?: Oazapfts.RequestOpts) {
  return oazapfts.ok(
    oazapfts.fetchText(`/grades/${encodeURIComponent(id)}`, {
      ...opts,
      method: 'DELETE',
    }),
  );
...
export function deleteLesson(id: string, opts?: Oazapfts.RequestOpts) {
  return oazapfts.ok(
    oazapfts.fetchText(`/lessons/${encodeURIComponent(id)}`, {
      ...opts,
      method: 'DELETE',
    }),
  );
...
export function deleteRoom(id: string, opts?: Oazapfts.RequestOpts) {
  return oazapfts.ok(
    oazapfts.fetchText(`/rooms/${encodeURIComponent(id)}`, {
      ...opts,
      method: 'DELETE',
    }),
  );
...
export function setTimeslotLength(length: number, opts?: Oazapfts.RequestOpts) {
  return oazapfts.ok(
    oazapfts.fetchText(
      `/server/timeslot-length${QS.query(
        QS.explode({
          length,
        }),
      )}`,
...
export function deleteStudentGroup(id: string, opts?: Oazapfts.RequestOpts) {
  return oazapfts.ok(
    oazapfts.fetchText(`/student-groups/${encodeURIComponent(id)}`, {
      ...opts,
      method: 'DELETE',
    }),
  );
...
export function removeStudentsFromStudentGroup(id: string, body: string[], opts?: Oazapfts.RequestOpts) {
  return oazapfts.ok(
    oazapfts.fetchText(
      `/student-groups/${encodeURIComponent(id)}/students`,
      oazapfts.json({
        ...opts,
        method: 'DELETE',
        body,
...
export function deleteStudent(id: string, opts?: Oazapfts.RequestOpts) {
  return oazapfts.ok(
    oazapfts.fetchText(`/students/${encodeURIComponent(id)}`, {
      ...opts,
      method: 'DELETE',
    }),
  );
...
export function deleteSubject(id: string, opts?: Oazapfts.RequestOpts) {
  return oazapfts.ok(
    oazapfts.fetchText(`/subjects/${encodeURIComponent(id)}`, {
      ...opts,
      method: 'DELETE',
    }),
  );
...
export function deleteTeacher(id: string, opts?: Oazapfts.RequestOpts) {
  return oazapfts.ok(
    oazapfts.fetchText(`/teachers/${encodeURIComponent(id)}`, {
      ...opts,
      method: 'DELETE',
    }),
  );
...
export function deleteTimeslot(id: string, opts?: Oazapfts.RequestOpts) {
  return oazapfts.ok(
    oazapfts.fetchText(`/timeslots/${encodeURIComponent(id)}`, {
      ...opts,
      method: 'DELETE',
    }),
  );
...
export function deleteTimetable(id: string, opts?: Oazapfts.RequestOpts) {
  return oazapfts.ok(
    oazapfts.fetchText(`/timetables/${encodeURIComponent(id)}`, {
      ...opts,
      method: 'DELETE',
    }),
  );
