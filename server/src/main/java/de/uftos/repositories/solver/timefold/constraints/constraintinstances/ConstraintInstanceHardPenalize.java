 ...
 * This instance is hard penalized when the evaluation function returns true.
 *
 ...
 */
public record ConstraintInstanceHardPenalize(
  ...
  public RewardPenalize rewardPenalize() {
    return RewardPenalize.HARD_PENALIZE;
  }
}
